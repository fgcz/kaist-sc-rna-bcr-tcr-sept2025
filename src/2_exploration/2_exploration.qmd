...
CCA is the original integration method implemented in Seurat, but it can be slow for large datasets. In addition, it has a tendency to over-correct, meaning it might obscure biological variation in the data beyond simply correcting for the technical noise we actually want to get rid of.
...
[![SC Integration Metrics](report_assets/integration_metrics.jpg)](https://www.biorxiv.org/content/10.1101/2025.01.21.634098v1)
:::
